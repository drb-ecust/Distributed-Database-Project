...
public class ClientDeadlock_WWWW {
    public static void main(String[] args) {
        ...
        try {
            ...
            //////////
            // new transaction 4: require X-Lock on Car and X-Lock on Flight, will cause deadlock when executing with f2
            //////////
            Transaction1 f1 = new Transaction1(wc);
            //////////
            // new transaction 5: require X-Lock on Car and X-Lock on Flight, will cause deadlock when executing with f1
            //////////
    ...
    private static class Transaction1 extends Thread {
        ...
        public void run() {
            ...
            try {
                xid = wc.start();
                System.out.printf("### Start Transaction xid=%d: require X-Lock on Car and X-Lock on Flight.\n", xid);
                if (!wc.addCars(xid, "1001", 50, 200)) {
...
//                sleep(5000); // sleep some time so that Transaction 2 will earlier require X-Lock on Car
    ...
    private static class Transaction2 extends Thread {
        ...
        public void run() {
            ...
            try {
                xid = wc.start();
                System.out.printf("### Start Transaction xid=%d: require X-Lock on Flights and X-Lock on Cars.\n", xid);
                if (!wc.addFlight(xid, "1001", 100, 1000)) {
                    System.out.println(xid + " : Add Flight failed");
                }

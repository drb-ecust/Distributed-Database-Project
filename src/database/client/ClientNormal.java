...
/**
 * Client code for test the normal case without any exception
 */

public class ClientNormal {

    public static void main(String[] args) {
        System.out.println("#################### Begin Test ClientNorm ####################");
        ...
        //////////
        // transactions for test normal case
        //////////
        int xid;
        try {
            //////////
            ...
            //////////
            // new transaction 4: reserve Flight, Car and Room
            //////////
            xid = wc.start();
            System.out.printf("### Start Transaction xid=%d: reserve Flight, Car and Room.\n", xid);
            ...
            //////////
            // new transaction 5: check consistency after reserve
            //////////
            xid = wc.start();
            System.out.printf("### Start Transaction xid=%d: check consistency after reserve.\n", xid);
            System.out.printf("Flight 1001 has %s available seats, the price is %d.\n",
                    wc.queryFlight(xid, "1001"), wc.queryFlightPrice(xid, "1001"));
            System.out.printf("Location ShangHai has %s available cars, the price is %d.\n",
                    wc.queryCars(xid, "ShangHai"), wc.queryCarsPrice(xid, "ShangHai"));
        ...
        System.out.println("#################### Finish Test ClientNorm ####################");

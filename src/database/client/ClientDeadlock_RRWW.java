...
public class ClientDeadlock_RRWW {
    public static void main(String[] args) {
        System.out.println("#################### Begin Test ClientDeadlock_RRWW ####################");
        ...
        try {
            ...
            //////////
            // new transaction 4: require R-Lock on Car and X-Lock on Car, will cause deadlock when executing with f2
            //////////
            Transaction1 f1 = new Transaction1(wc);
            //////////
            // new transaction 5: require R-Lock on Car and X-Lock on Car, will cause deadlock when executing with f1
            //////////
        ...
        System.out.println("#################### Finish Test ClientDeadlock_RRWW ####################");
    ...
    private static class Transaction1 extends Thread {
        ...
        public Transaction1(WorkflowController wc){this.wc = wc;}
        public void run() {
            int xid = -1;
            try {
                xid = wc.start();
                System.out.printf("### Start Transaction xid=%d: require R-Lock on Car and X-Lock on Car.\n", xid);
                System.out.printf("shanghai has %s available cars, the price is %d.\n",
                        wc.queryCars(xid, "shanghai"), wc.queryCarsPrice(xid, "shanghai"));
    ...
    private static class Transaction2 extends Thread {
        ...
        public Transaction2(WorkflowController wc){this.wc = wc;}
        public void run() {
            int xid = -1;
            try {
                xid = wc.start();

...
/**
 * Client code for test the case when TM die before commit
 */
public class ClientDieTMBeforeCommit {
    public static void main(String[] args) {
        System.out.println("#################### Begin Test ClientDieTMBeforeCommit ####################");
        ...
        try {
            ...
            //////////
            // new transaction 4: reserve Flight, Car and Room, but TM will die before commit
            //////////
            xid = wc.start();
            System.out.printf("### Start Transaction xid=%d: reserve Flight, Car and Room, but TM will die before commit.\n", xid);
            wc.dieTMBeforeCommit(); // set a flag and info TM to die before the next commit
            ...
            if (!wc.commit(xid)) {
                System.out.printf("### Commit Transaction xid=%d: failed due to TM die before commit! After recover, the TM will info each RM to abort, the consistency is still guaranteed.\n", xid);
            } else {
                System.out.printf("### Commit Transaction xid=%d: success!\n", xid);
            }
        ...
        System.out.println("#################### Finish Test ClientDieTMBeforeCommit ####################");

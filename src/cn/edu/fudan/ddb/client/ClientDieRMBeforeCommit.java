...
/**
 * Client code for test the case when RM die before commit
 */
public class ClientDieRMBeforeCommit {
    public static void main(String[] args) {
        System.out.println("#################### Begin Test ClientDieRMBeforeCommit ####################");
        ...
        try {
            ...
            //////////
            // new transaction 4: reserve Flight, Car and Room, but RM will die before commit
            //////////
            xid = wc.start();
            System.out.printf("### Start Transaction xid=%d: reserve Flight, Car and Room, but RM will die before commit.\n", xid);
            wc.dieRMBeforeCommit(ResourceManager.RMI_NAME_RM_FLIGHTS); // set a flag and info Flight RM to die before the next commit
            ...
            if (!wc.commit(xid)) {
                ...
                System.out.printf("### Commit Transaction xid=%d: success! If RM die before commit, it will recommit after recover, the consistency is still guaranteed.\n", xid);
            }
        ...
        System.out.println("#################### Finish Test ClientDieRMBeforeCommit ####################");

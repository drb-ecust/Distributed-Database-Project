...
/**
 * Client code for test the case when RM die before prepare
 */
public class ClientDieRMBeforePrepare {
    public static void main(String[] args) {
        System.out.println("#################### Begin Test ClientDieRMBeforePrepare ####################");
        ...
        try {
            ...
            //////////
            // new transaction 4: reserve Flight, Car and Room, but RM will die before prepare
            //////////
            xid = wc.start();
            System.out.printf("### Start Transaction xid=%d: reserve Flight, Car and Room, but RM will die before prepare.\n", xid);
            wc.dieRMBeforePrepare(ResourceManager.RMI_NAME_RM_FLIGHTS); // set a flag and info Flight RM to die before the next prepare
            ...
            try {
                ...
                // e.printStackTrace();
                System.out.printf("### Commit Transaction xid=%d: failed due to RM die before prepare! Abort all instead, the consistency is still guaranteed.\n", xid);
            }
        ...
        System.out.println("#################### Finish Test ClientDieRMBeforePrepare ####################");

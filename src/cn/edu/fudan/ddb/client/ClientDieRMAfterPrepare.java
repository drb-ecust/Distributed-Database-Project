...
/**
 * Client code for test the case when RM die after prepare
 */
public class ClientDieRMAfterPrepare {
    public static void main(String[] args) {
        System.out.println("#################### Begin Test ClientDieRMAfterPrepare ####################");
        ...
        try {
            ...
            //////////
            xid = wc.start();
            System.out.printf("### Start Transaction xid=%d: reserve Flight, Car and Room, but RM will die after prepare.\n", xid);
        ...
        System.out.println("#################### Finish Test ClientDieRMAfterPrepare ####################");

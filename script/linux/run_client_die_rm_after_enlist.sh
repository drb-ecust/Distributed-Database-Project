...
# step 5: run ClientDieRMAfterEnlist

java -classpath "$CLASS_PATH" -DrmiPort="$RMI_REGISTRY_PORT" database.client.ClientDieRMAfterEnlist &

# step 6: recover RM Hotel
# wait some time to make sure rm already die after enlist
sleep 5

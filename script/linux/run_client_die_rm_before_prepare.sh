...
# step 5: run ClientDieRMBeforePrepare
# wait some time to make sure rms, tm and wc have enough time to start up

java -classpath "$CLASS_PATH" -DrmiPort="$RMI_REGISTRY_PORT" database.client.ClientDieRMBeforePrepare &

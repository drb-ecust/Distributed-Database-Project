...
@REM Test ClientDieTMBeforeCommit
...
@REM step 5: run ClientDieTMBeforeCommit
@REM wait some time to make sure rms, tm and wc have enough time to start up
timeout /t 5 /nobreak >nul
start "Client-Die-TM-Before-Commit" java -classpath %CLASS_PATH% -DrmiPort=%RMI_REGISTRY_PORT% cn.edu.fudan.ddb.client.ClientDieTMBeforeCommit
